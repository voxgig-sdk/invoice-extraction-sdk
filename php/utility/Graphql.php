...
// InvoiceExtraction SDK utility: graphql
//
...
class InvoiceExtractionGraphql
{
    ...
    // equivalent.
    public static function body(InvoiceExtractionContext $ctx): mixed
    {
    ...
    public static function errors(InvoiceExtractionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
