...
// InvoiceExtraction SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (InvoiceExtractionSDK::test)
...
{
    private const SDK_CLASS = 'InvoiceExtractionSDK';
    ...
    private const SDK_BASE = 'invoiceextraction_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../invoiceextraction_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
