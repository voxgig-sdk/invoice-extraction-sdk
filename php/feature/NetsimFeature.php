...
// InvoiceExtraction SDK netsim feature
...
class InvoiceExtractionNetsimFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _simulate(InvoiceExtractionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(InvoiceExtractionContext $ctx, array $applied): void
    {
        $client = $this->client;
