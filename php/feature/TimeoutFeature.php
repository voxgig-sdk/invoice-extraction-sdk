...
// InvoiceExtraction SDK timeout feature
...
class InvoiceExtractionTimeoutFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _with_timeout(InvoiceExtractionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(InvoiceExtractionContext $_ctx, float $ms): void
    {
        $client = $this->client;
