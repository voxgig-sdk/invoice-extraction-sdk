...
// InvoiceExtraction SDK paging feature
...
class InvoiceExtractionPagingFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _is_list(InvoiceExtractionContext $ctx): bool
    {
