...
// InvoiceExtraction SDK audit feature
...
class InvoiceExtractionAuditFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _emit(InvoiceExtractionContext $ctx, string $outcome): void
    {
