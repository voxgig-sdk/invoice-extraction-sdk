# InvoiceExtraction SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions InvoiceExtractionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both InvoiceExtractionSDK(...) and InvoiceExtractionSDK.test(...) become
#      InvoiceExtractionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "invoiceextraction_sdk"
_SDK_CLASS = "InvoiceExtractionSDK"
...
_ENTITIES = {
    "Health": "health",
    "InvoiceExtraction": "invoice_extraction",
}
