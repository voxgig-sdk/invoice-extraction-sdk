...
from invoiceextraction_sdk.core.spec import InvoiceExtractionSpec
from invoiceextraction_sdk.core.result import InvoiceExtractionResult
from invoiceextraction_sdk.core.response import InvoiceExtractionResponse
from invoiceextraction_sdk.core.operation import InvoiceExtractionOperation
from invoiceextraction_sdk.core.error import InvoiceExtractionError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return InvoiceExtractionError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = InvoiceExtractionSDK.test(None, None)
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = InvoiceExtractionResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = InvoiceExtractionSDK.test(None, None)
        ...
        class TestInitFeature(InvoiceExtractionBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(InvoiceExtractionBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = InvoiceExtractionSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = InvoiceExtractionSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = InvoiceExtractionSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = InvoiceExtractionSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = InvoiceExtractionSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = InvoiceExtractionOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = InvoiceExtractionSDK.test(None, setup_opts)
