...
from invoiceextraction_sdk.invoiceextraction_types import (
    InvoiceExtraction,
...
class InvoiceExtractionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InvoiceExtractionEntity(self._client, opts)
    ...
    def data_get(self) -> InvoiceExtraction:
    ...
    def match_get(self) -> InvoiceExtraction:
    ...
    def create(self, reqdata: InvoiceExtractionCreateData, ctrl=None) -> InvoiceExtraction:
        utility = self._utility
