...
from invoiceextraction_sdk.core.control import InvoiceExtractionControl
...
from invoiceextraction_sdk.core.helpers import get_ctx_prop, to_map
...
class InvoiceExtractionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = InvoiceExtractionControl()
        ...
        if isinstance(sp, InvoiceExtractionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, InvoiceExtractionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, InvoiceExtractionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return InvoiceExtractionOperation({})
    ...
    def make_error(self, code, msg):
        return InvoiceExtractionError(code, msg, self)
