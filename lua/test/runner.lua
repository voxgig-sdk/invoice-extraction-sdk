...
function runner.env_override(m)
  local live = runner.getenv("INVOICE_EXTRACTION_TEST_LIVE")
  local override = runner.getenv("INVOICE_EXTRACTION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("INVOICE_EXTRACTION_TEST_EXPLAIN")
