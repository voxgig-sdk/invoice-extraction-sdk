...
function runner.env_override(m)
  local live = runner.getenv("INVOICEEXTRACTION_TEST_LIVE")
  local override = runner.getenv("INVOICEEXTRACTION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("INVOICEEXTRACTION_TEST_EXPLAIN")
