...
// InvoiceExtraction SDK utility: fetcher

class InvoiceExtractionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; InvoiceExtractionSDK/1.0)';
    ...
    public static function call(InvoiceExtractionContext $ctx, string $fullurl, array $fetchdef): array
    {
