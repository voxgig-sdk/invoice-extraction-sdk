...
// InvoiceExtraction SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class InvoiceExtractionTransformResponse
{
    public static function call(InvoiceExtractionContext $ctx): mixed
    {
        ...
        $transform = InvoiceExtractionHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
