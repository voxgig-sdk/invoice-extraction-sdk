...
// InvoiceExtraction SDK utility type

class InvoiceExtractionUtility
{
    ...
    public static function copy(InvoiceExtractionUtility $src): InvoiceExtractionUtility
    {
        $u = new InvoiceExtractionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
