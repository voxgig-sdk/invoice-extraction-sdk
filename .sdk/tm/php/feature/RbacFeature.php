...
// InvoiceExtraction SDK rbac feature
...
class InvoiceExtractionRbacFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _required(InvoiceExtractionContext $ctx): ?string
    {
    ...
    private function _reject(InvoiceExtractionContext $ctx, string $required): void
    {
    ...
    private function _track(InvoiceExtractionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
