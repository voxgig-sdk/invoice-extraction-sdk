...
// InvoiceExtraction SDK proxy feature
...
class InvoiceExtractionProxyFeature extends InvoiceExtractionBaseFeature
{
    ...
    public function init(InvoiceExtractionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (InvoiceExtractionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
