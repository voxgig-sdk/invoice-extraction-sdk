...
// InvoiceExtraction SDK telemetry feature
...
class InvoiceExtractionTelemetryFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _close(InvoiceExtractionContext $ctx, bool $ok): void
    {
