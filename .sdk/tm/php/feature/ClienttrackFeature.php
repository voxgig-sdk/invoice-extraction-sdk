...
// InvoiceExtraction SDK clienttrack feature
...
class InvoiceExtractionClienttrackFeature extends InvoiceExtractionBaseFeature
{
    ...
    public function PostConstruct(InvoiceExtractionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'InvoiceExtraction-SDK';
