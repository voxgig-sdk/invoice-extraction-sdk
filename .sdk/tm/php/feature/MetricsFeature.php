...
// InvoiceExtraction SDK metrics feature
...
class InvoiceExtractionMetricsFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _record(InvoiceExtractionContext $ctx, bool $ok): void
    {
