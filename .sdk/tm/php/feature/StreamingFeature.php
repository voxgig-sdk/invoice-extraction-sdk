...
// InvoiceExtraction SDK streaming feature
...
class InvoiceExtractionStreamingFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _iterate(InvoiceExtractionResult $result): \Generator
    {
    ...
    private function _streamable(InvoiceExtractionContext $ctx): bool
    {
