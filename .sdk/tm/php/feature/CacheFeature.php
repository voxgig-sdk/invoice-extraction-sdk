...
// InvoiceExtraction SDK cache feature
...
class InvoiceExtractionCacheFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _through(InvoiceExtractionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
