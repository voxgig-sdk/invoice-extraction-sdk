...
// InvoiceExtraction SDK ratelimit feature
...
class InvoiceExtractionRatelimitFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _acquire(InvoiceExtractionContext $ctx): void
    {
    ...
    private function _track(InvoiceExtractionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
