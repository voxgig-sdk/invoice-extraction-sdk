...
// InvoiceExtraction SDK idempotency feature
...
class InvoiceExtractionIdempotencyFeature extends InvoiceExtractionBaseFeature
{
    ...
    private function _mutating(InvoiceExtractionContext $ctx): bool
    {
