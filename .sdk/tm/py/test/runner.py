...
class InvoiceExtractionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InvoiceExtractionTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = InvoiceExtractionTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = InvoiceExtractionTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
