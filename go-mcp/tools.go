...
type Args struct {
	Entity string         `json:"entity" jsonschema:"health | invoice_extraction"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.InvoiceExtractionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "invoice-extraction_list",
		Description: "List records from InvoiceExtraction. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "invoice-extraction_load",
		Description: "Load a single record from InvoiceExtraction. " +
...
func runOp(client *sdk.InvoiceExtractionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.InvoiceExtractionSDK, name string) (sdk.InvoiceExtractionEntity, error) {
	switch strings.ToLower(name) {
	case "health":
		return client.Health(nil), nil
	case "invoice_extraction":
		return client.InvoiceExtraction(nil), nil
