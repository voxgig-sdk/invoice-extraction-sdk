// Command InvoiceExtraction-mcp is an MCP server exposing the InvoiceExtraction
// SDK as MCP tools.
//
// Two tools are registered:
//
//	InvoiceExtraction_list  — list records of an entity
//	InvoiceExtraction_load  — load a single record of an entity
//
