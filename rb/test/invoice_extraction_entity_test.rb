...
class InvoiceExtractionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set INVOICEEXTRACTION_TEST_INVOICE_EXTRACTION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def invoice_extraction_basic_setup(extra)
  ...
  entid_env_raw = ENV["INVOICEEXTRACTION_TEST_INVOICE_EXTRACTION_ENTID"]
