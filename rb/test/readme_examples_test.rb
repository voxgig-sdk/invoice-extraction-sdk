...
#      offline in seeded test mode (InvoiceExtractionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "InvoiceExtraction_sdk.rb")
  SDK_CLASS = "InvoiceExtractionSDK"
  ...
  SDK_BASE = "InvoiceExtraction_sdk"
