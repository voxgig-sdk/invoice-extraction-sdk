...
func registerSDKWords(r *eng.Registry, client *sdk.InvoiceExtractionSDK) {
...
func runOp(client *sdk.InvoiceExtractionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
